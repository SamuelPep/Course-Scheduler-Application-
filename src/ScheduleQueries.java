...
public class ScheduleQueries {
    // remember, when creating methods for Queries, we predefine them as an instance variable
    ...
    public static void addSchedule(ScheduleEntry entry){
        //associate the method with a connection to the database. Done by utilizing the class DB connection, which, in itself, is used to connect to the database 
        connection = DBConnection.getConnection();
        //After the connection variable we do the next lines of code in a try bracket
        try{
    ...
    public static ArrayList<ScheduleEntry> getScheduleByStudent(String semester, String studentID)
    {
        ...
        try
        {
            getScheduleByStudent = connection.prepareStatement("select semester, coursecode, studentid, status, timestamp from app.schedule");
            ...
            while(resultSet.next())
            {
                ...
                String seme = resultSet.getString(3);
                String studentid = resultSet.getString(4);
                Timestamp timestamp = resultSet.getTimestamp(5);
                ScheduleEntry sc = new ScheduleEntry(semester, coursecode, studentid, status, timestamp);
